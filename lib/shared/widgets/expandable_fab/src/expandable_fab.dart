...
class CustomExpandableFab extends StatefulWidget {
  ...
  @override
  State<CustomExpandableFab> createState() => CustomExpandableFabState();
}

class CustomExpandableFabState extends State<CustomExpandableFab>
  ...
  @override
  void didUpdateWidget(covariant CustomExpandableFab oldWidget) {
  ...
  Widget build(BuildContext context) {
    final location = CustomExpandableFab.location as _ExpandableFabLocation;
    Offset? offset;
    Widget? cache;
  ...
  List<Widget> _buildExpandingActionButtons(Offset offset) {
    ...
    switch (widget.pos) {
      ...
      case ExpandableFabPos.center:
        totalOffset += Offset(0, widget.childrenOffset.dy + buttonOffset);
        break;
    }
