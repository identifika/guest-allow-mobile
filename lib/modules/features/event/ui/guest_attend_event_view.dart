...
import 'package:guest_allow/modules/features/event/controllers/guest_attend_event.controller.dart';
import 'package:guest_allow/shared/widgets/circle_button.dart';
import 'package:lottie/lottie.dart';

class GuestAttendEventView extends StatelessWidget {
  const GuestAttendEventView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(GuestAttendEventController());
  ...
  Widget buildCamera(BuildContext context) {
    var controller = GuestAttendEventController.to;
    return Stack(
      children: [
        Stack(
          children: [
  ...
  Align _countdownWidget(GuestAttendEventController controller) {
    return Align(
  ...
  Align _livenessWIdget(GuestAttendEventController controller) {
    return Align(
      ...
      child: Obx(
        () => controller.stateLiveness.value.maybeWhen(
          ...
          orElse: () => GetBuilder<GuestAttendEventController>(
              id: 'animation',
              builder: (state) {
  ...
  Stack _cameraLayout(GuestAttendEventController controller) {
    return Stack(
      children: [
        Transform.scale(
          alignment: Alignment.topCenter,
