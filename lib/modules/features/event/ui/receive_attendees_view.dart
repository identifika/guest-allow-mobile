...
class ReceiveAttendeesView extends StatelessWidget {
  const ReceiveAttendeesView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ReceiveAttendeController());
  ...
  Widget buildCamera(BuildContext context) {
    var controller = ReceiveAttendeController.to;
    return Stack(
      children: [
        Stack(
          children: [
  ...
  Align _countdownWidget(ReceiveAttendeController controller) {
    return Align(
  ...
  Align _livenessWIdget(ReceiveAttendeController controller) {
    return Align(
      ...
      child: Obx(
        () => controller.stateLiveness.value.maybeWhen(
          ...
          orElse: () => GetBuilder<ReceiveAttendeController>(
              id: 'animation',
              builder: (state) {
  ...
  Stack _cameraLayout(ReceiveAttendeController controller) {
    return Stack(
      children: [
        Transform.scale(
          alignment: Alignment.topCenter,
