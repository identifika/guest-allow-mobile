...
//
//     final placeSuggestionResponse = placeSuggestionResponseFromJson(jsonString);

import 'dart:convert';

PlaceSuggestionResponse placeSuggestionResponseFromJson(String str) =>
    PlaceSuggestionResponse.fromJson(json.decode(str));

String placeSuggestionResponseToJson(PlaceSuggestionResponse data) =>
...
class PlaceSuggestionResponse {
  ...
  PlaceSuggestionResponse copyWith({
    List<Prediction>? predictions,
    String? status,
  }) =>
      PlaceSuggestionResponse(
