...
class _$UIStateSuccessImpl<T> extends UIStateSuccess<T> {
  const _$UIStateSuccessImpl({required this.data}) : super._();
...
abstract class UIStateSuccess<T> extends UIState<T> {
  const factory UIStateSuccess({required final T data}) =
      _$UIStateSuccessImpl<T>;
  const UIStateSuccess._() : super._();
...
abstract class UIStateEmpty<T> extends UIState<T> {
  const factory UIStateEmpty({final String message}) = _$UIStateEmptyImpl<T>;
  const UIStateEmpty._() : super._();
...
class _$UIStateLoadingImpl<T> extends UIStateLoading<T> {
  const _$UIStateLoadingImpl() : super._();
...
abstract class UIStateLoading<T> extends UIState<T> {
  const factory UIStateLoading() = _$UIStateLoadingImpl<T>;
  const UIStateLoading._() : super._();
}
...
abstract class UIStateError<T> extends UIState<T> {
  const factory UIStateError({final String message}) = _$UIStateErrorImpl<T>;
  const UIStateError._() : super._();
...
class _$UIStateIdleImpl<T> extends UIStateIdle<T> {
  const _$UIStateIdleImpl() : super._();
...
abstract class UIStateIdle<T> extends UIState<T> {
  const factory UIStateIdle() = _$UIStateIdleImpl<T>;
  const UIStateIdle._() : super._();
}
